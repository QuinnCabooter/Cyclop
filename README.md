...
- `Alsico_with_manual_annotations.py`: The main file for running the experiment with the ability to enter manual annotations ***This file should not be edited without the author's knowledge***.
