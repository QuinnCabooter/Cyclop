...
fig = make_subplots(rows=5, cols=2,subplot_titles=['EDA', 'RH_1','CO2_0', 'TEMP_1', 'RH_0', 'Geen Ventilatie', 'TEMP_0', 'Ventilatie', 'CO2_1' ])
fig.update_layout(height=1400, width=1500)
...
fig.write_image(wd + "file.png")
#df_out.to_csv(wd + 'df_out.csv', index = False)
